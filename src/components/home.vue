<template>
    <div>
        ...
        <img id="mobileimage" src= "./../assets/23.jpg"/>
        <div class="home">
            <div class="main-text" style="text-align: right;">
                <p id="cytaty"><i>"Un gramme de pratique vaut
                    autant qu'une tonne de théorisation."<br><span style="color:#f1c065">Wallace Wattles</span></i>
                </p> 
            </div> 
            <div class="container">
                    ...
                    <div class="col-sm-offset-2 col-sm-8 col-sm-offset-2">
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">  
                            <div class="carousel-inner">
                                ...
                                <div class="item">
                                <img src="./../assets/feature_slide_2.png"/>
                                </div>

                                <div class="item">
                                <img src="./../assets/feature_slide_3.png"/>
                                </div>
                            </div>
