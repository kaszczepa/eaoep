<template>
    <div>
        <div class="container">
            ...
            <p class="font_regular">Avec un succès, nous comparons nos expériences et nous nous inspirons 
            ...
            <p class="font_regular">Nous cherchons notre inspiration dans les bonnes pratiques de l’Université
                ...
                d’une aide reçue, ils paient leur dette de gratitude.<br><br>Nous voudrions que la coopération de
                l’AEPE et des représentants du monde des affaires soit fondée sur l'intérêt réciproque. Nous 
                encouragerions cette mission par une aide matérielle et immatérielle de nos activités.
            </p>
            <p class="font_regular">Après 3 mois de l’adhésion à l’AEPE, nos membres peuvent demander un
                soutien financier qui serait transmis en quelques heures. Dans le cas du payement d’une 
                cotisation annuelle, on a la possibilité de recevoir un soutien financier de 40 000 euros.
                Dans le cas des cotisations mensuelles, les membres peuvent obtenir un soutien de 4000 euros.
            ...
            <ul class="list0 nls-None font_regular">
                <li>de la promotion de l’entreprise au marché national ( notamment sur le site : www.eaoep.eu)
                </li>
            ...
            <div class=" mail">
                ...
                <div class="container">
                <button class="button" style="float:none">Envoyer</button>
                </div>
            </div>
        </div>
    </div>
